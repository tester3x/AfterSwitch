/**
 * TEMPORARY EXPERIMENT ENTRY POINT — delete after the experiment.
 *
 ...
 * gate, no cloud, no sharing, no companion networking, no profile IO.
 *
 * The import chain from here reaches react-native and the settings bridge
 * only — verified before this file was written.
 */
        ...
        <ScrollView contentContainerStyle={styles.content}>
          <View style={styles.banner}>
            ...
            <Text style={styles.bannerText}>
              Temporary experiment build. Separate package, separate data.
              It cannot read or change your real AfterSwitch profiles.
            </Text>
          </View>
